        ...
        <div className="fullbleed-header">
            ...
            <div className="home-index-container">
                ...
                <div className="tabs">
                    <ul className="tabs-events">
                        <li className="interactive">All</li>
                        <li>For You</li>
                        <li>Online</li>
                        <li>Today</li>
                        <li>This Weekend</li>
            ...
            <div className="category-tiles">
                ...
                <div className="tile-group">
                    <a href="/">Music</a>
                    {/* <div class="tile">
                        <aside class="tile--icon">
                            <i class="eds-vector-image eds-icon--small eds-vector-image--ui-orange" data-spec="icon" data-testid="icon" aria-hidden="true">
                                {/* <svg id="music-note_svg__eds-icon--music-note_svg" x="0" y="0" viewBox="0 0 24 24" > */}
                                    {/* <path id="music-note_svg__eds-icon--music-note_base" fill-rule="evenodd" clip-rule="evenodd" d="M21 2L8 5.5v11.3c-.5-.5-1.2-.8-2-.8-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3V9.5l11-3v7.2c-.5-.5-1.2-.8-2-.8-1.7 0-3 1.3-3 3s1.3 3 3 3 3-1.3 3-3V2zM6 21c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM9 8.5V6.2l11-3v2.3l-11 3zm9 9.5c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z">
                                        </path>
                                        {/* </svg> */}
                                        {/* </i> */}
                                        {/* </aside> */}
                                        {/* <div class="tile--name eds-text-weight--heavy">Music */}
                                        {/* </div> */}
                                        {/* </div> */}
